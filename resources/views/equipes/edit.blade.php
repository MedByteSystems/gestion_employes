                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('equipes.update', $equipe) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nom" id="nom" value="{{ old('nom', $equipe->nom) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $equipe->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="responsable_id" id="responsable_id"
                                ...
                                @if ($equipe->responsable)
                                    <option value="{{ $equipe->responsable->id }}" selected>
